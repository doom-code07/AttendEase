...
<div class="container">
    ...
    <aside class="sidebar">
        ...
        <ul>
            <li><a href="VicePrincipalStruckOffServlet" target="content-frame">
                <i class="fas fa-user-times"></i> Manage Struck Off
            </a></li>
            <li><a href="set_policies.jsp" target="content-frame">
                <i class="fas fa-cogs"></i> Set Policies
            </a></li>
            <li><a href="check_applications.jsp" target="content-frame">
