...
<body>
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <ul>
                <li>
                    <a href="ActiveApprovedLeavesServlet" target="content-frame">
                        <i class="fas fa-marker"></i> Mark Attendance
                    </a>
                </li>
                <li>
                    <a href="update_attendance.jsp" target="content-frame">
                        <i class="fas fa-edit"></i> Update Attendance
                    </a>
                </li>
                <li>
                    <a href="TeacherApplicationsServlet" target="content-frame">
