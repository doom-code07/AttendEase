...
<div class="container">
    ...
    <aside class="sidebar">
        ...
        <ul>
            <li><a href="ViewAttendanceServlet" target="content-frame">
                <i class="fas fa-check-circle"></i> View Attendance
            </a></li>
            <li><a href="submit_application.jsp" target="content-frame">
                <i class="fas fa-file-alt"></i> Submit Application
            </a></li>
            <li><a href="check_status.jsp" target="content-frame">
