...
<div class="container">
    ...
    <aside class="sidebar">
        ...
        <ul>
            ...
            <li><a href="manage_classes.jsp" class="active"><i class="fas fa-school"></i> Manage Classes</a></li>
        ...
        <section class="form-section">
            ...
            %>
               ...
               <form action="AddClassServlet" method="post">
                   <input type="text" name="className" placeholder="Enter Class Name" pattern="[A-Za-z0-9 ]+"
