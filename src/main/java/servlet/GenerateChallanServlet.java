...
public class GenerateChallanServlet extends HttpServlet {
    ...
    // Build a neat, printable challan page (simple format—customize anytime)
    private void addChallan(Document doc, String studentName, String rollNo, String className, int fineAmount, LocalDate issueDate)
        ...
        // Header / title
        Paragraph title = new Paragraph("Institute Name\nFee Challan", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 18));
        ...
        // Footer / instructions (example text)
