...
public class StudentRegisterServlet extends HttpServlet {
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            int classId = Integer.parseInt(req.getParameter("class_id")); // 👈 fetch class ID
            ...
            int studentId = new StudentDAO().insertStudentReturnId(student); // 👈 you’ll modify this
            new ClassStudentDAO().assignClassToStudent(studentId, classId); // 👈 assign class
